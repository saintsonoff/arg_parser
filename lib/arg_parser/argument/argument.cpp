...
Argument::Argument(std::string_view full_name,
  std::string_view short_name, std::string_view descriprion) :
    full_name_(full_name), short_name_(short_name), description_(descriprion),
...
Argument::Argument(Argument&& value) :
  full_name_(value.full_name_), short_name_(value.short_name_), description_(value.description_),
